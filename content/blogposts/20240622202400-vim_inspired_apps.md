...
{{< figure src="/images/vim-apps/ranger.png" >}}
...
{{< figure src="/images/vim-apps/vifm.gif" >}}
...
### Plugins for Firefox and Chrome {#plugins-for-firefox-and-chrome}
...
You'll find more information on it's ArchWiki page [here](https://wiki.archlinux.org/title/Zathura).
...
### Calcuse Calendar and todos {#calcuse-calendar-and-todos}
...
{{< figure src="/images/vim-apps/calcurse.gif" >}}


### Vi-mode on bash and zsh {#vi-mode-on-bash-and-zsh}
...
For **Bash** is as easy as adding "_set -o vi_" to your _.bashrc_

**Zsh** isn't any harder, you just need to add "_bindkey -v_" to your _.zshrc_
...
to improve it. You can check out my [dotfiles](https://github.com/migueldeoleiros/dotfiles/tree/master/.config/tmux) for inspiration.
