...
Links: [Personal Blog]({{< relref "20240622202252-personal_blog.md" >}}), [turtile]({{< relref "20240707231013-turtile.md" >}})
...
That's what lead me to start the development of **turtile**, a [wlroots](https://gitlab.freedesktop.org/wlroots/wlroots)-based Wayland compositor.
...
I spent a lot of time reading about the **Wayland protocol** and **wlroots**, starting with the classic [Drew DeVault's blog posts](https://drewdevault.com/2017/06/10/Introduction-to-Wayland.html), which currently are a bit outdated, but still help understanding the basics. A source that is a lot more detailed is [The Wayland Book](https://wayland-book.com/), and it was increasingly helpful to use as reference during development.

I also spent a good amount of time reading code for other projects:

-   [Vivarium](https://github.com/inclement/vivarium) was pretty useful as reference, even though it hasn't been updated lately, it's a relatively small project and that helps a lot to understand the overall structure of how things work.
-   [dwl](https://codeberg.org/dwl/dwl) was a great reference too. I don't like the code style used for suckless projects, but it's undeniable that the small codebase makes it really easy to figure out.
-   I also took a look at some **X11 window managers' code**, most notably [bspwm](https://github.com/baskerville/bspwm), since I was interested in the way they manage commands with a socket. I ended up implementing a similar solution based on their code in turtile as well.
...
I based my code in [tinywl](https://gitlab.freedesktop.org/wlroots/wlroots/-/tree/master/tinywl), the demo provided by the wlroots library. This made the initial development a lot easier, and it's also the main reason I used **C**.
...
-   **GitHub Projects** can be a great tool to manage all code related tasks, since it uses _issues_ as a base for each task and you can associate other things like pull requests to change the state of tasks in a kanban board.
...
And of course, for anyone interested, check out **[turtile on GitHub](https://github.com/migueldeoleiros/turtile)**  **all contributions are welcomed!**
I'll also be diving into more **technical details** and **design** of the compositor in a future post.

{{< figure src="https://raw.githubusercontent.com/migueldeoleiros/turtile/refs/heads/master/assets/banner_turtile.svg" >}}
