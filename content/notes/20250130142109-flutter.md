...
A tool for [Mirror Android on Linux]({{< relref "20250213123437-mirror_android_on_linux.md" >}}) like [scrcpy]({{< relref "20250213123437-mirror_android_on_linux#https-github-dot-com-genymobile-scrcpy-scrcpy" >}}) can be useful to run apps on a real machine with the VM feeling.
...
## [StatelessWidget]({{< relref "20250211103703-flutter_statelesswidget.md" >}}) {#statelesswidget--20250211103703-flutter-statelesswidget-dot-md}


## [StatefulWidget]({{< relref "20250211103724-flutter_statefulwidget.md" >}}) {#statefulwidget--20250211103724-flutter-statefulwidget-dot-md}


## [WebSocket in Flutter]({{< relref "20250211162721-websocket_in_flutter.md" >}}) {#websocket-in-flutter--20250211162721-websocket-in-flutter-dot-md}
