...
### 1. Crear un issue en gittea {#1-dot-crear-un-issue-en-gittea}
...
Una vez tengas algún commit podrás subir la rama al repositorio con `git push` y deberás **asociar dicha rama al issue** en gittea.
...
El titulo del PR debe ser descriptivo, para cerrar automáticamente el issue asociado deber añadir "Closes #issue-id" deber ser algo como el siguiente ejemplo:
