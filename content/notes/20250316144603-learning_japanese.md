...
### Jisho Dictionary {#jisho-dictionary}
...
### Dong Chinese character wiki {#dong-chinese-character-wiki}
...
### Tae Kim Guide to Learning Japanese {#tae-kim-guide-to-learning-japanese}
...
This one is specially useful, even if you don't have [Furigana](#furigana) you can get the reading of kanji with Yomitan


## Previously tried options {#previously-tried-options}


### Wanikani Unimate 3: Tokyo Drift Anki deck {#wanikani-unimate-3-tokyo-drift-anki-deck}

For getting the deck there is a [discord server](https://discord.gg/A3zRWUfzkj)
This deck contains a port of the [Wanikani](https://www.wanikani.com/) course by Tofugu
