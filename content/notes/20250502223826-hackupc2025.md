...
A simple Flutter app that makes use of [Bluetooth Low Energy]({{< relref "20250508142034-bluetooth_low_energy.md" >}}) for creating a mesh like network of phones that can communicate flight and alert information in a a UDP like manner.
